...
export const projects: Project[] = [
  ...
  },
  {
    ...
    thumbnail: "/project-figma-starter1.jpg",
    showOnHomepage: true,
    ...
    content: [
      {
        ...
        images: [
          {
            src: "/project-figma-starter1.jpg",
            caption: "Claude chat running /figma-project-starter against a bare Asana link, showing the reasoning trail and finished file link",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        framed: true,
        images: [
          { src: "/project-figma-starter2.jpg", caption: "Marketing Design team folder structure by brand" },
          { src: "/project-figma-starter3.jpg", caption: "BigCommerce folder showing live files with filled covers, REQ numbers, and initials" },
        ],
      },
      {
        type: "text",
